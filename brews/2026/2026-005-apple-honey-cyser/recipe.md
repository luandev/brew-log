...
|---|---:|---|
| Fresh apple juice | ~3 L | Main fruit base |
...
- High-alcohol-tolerance wine yeast was pitched on 2026-09-05.
- Exact strain and pitch amount were not recorded.
- The working goal is a very strong mead; the actual attainable alcohol ceiling depends on the exact yeast and fermentation health.
...
- 2 kg honey was added on brew day.
- No additional honey is committed at this stage.
- Any future honey step-feed should be gravity-led, added only after healthy fermentation is established, and logged as an actual measured addition.
...
- Two cinnamon sticks were added in a tea bag on brew day.
- Taste during primary/early secondary and remove the cinnamon if it becomes dominant or woody.

### Clarification

- Pectic enzyme was used during apple and pear juice extraction; exact dose was not recorded.
- Clarification happens after fermentation is sufficiently complete/stable; active yeast and CO2 may keep the batch cloudy during primary.
...
- Style direction: high-strength apple-dominant fruit mead with pear softness, cranberry acidity and restrained cinnamon
...
- Method: still mead unless later changed and recorded
- Priming sugar: none planned
- Bottle type: suitable sanitised still-wine/mead bottle
- Bottle only after fermentation is fully stable, the mead has cleared sufficiently, and no renewed fermentation follows any late adjustment
...
1. Sanitise the fermenter, tools, juicer, and anything contacting the must.
2. Extract apple and pear juices, using pectic enzyme during both juice-extraction steps.
3. Combine approximately 3 L apple juice, 1.5 L pear juice, and 0.5 L cranberry juice.
4. Add 2 kg honey and mix thoroughly.
5. Take the first hydrometer sample; it reads above the useful range of the instrument.
...
14. When gravity is stable and primary is sufficiently complete, rack off the gross lees into a sanitised secondary vessel.
15. Taste in secondary and make no additional fruit/spice addition by default unless deliberately chosen and recorded.
16. Allow the mead to clear under airlock; rack again only if a significant sediment layer develops.
17. Take a final stability reading before bottling.
18. Bottle as still mead with no priming sugar once fermentation is stable and clarity is acceptable.
19. Age in bottle; a high-strength mead should be expected to improve with extended maturation.
...
5. Bottling: still mead after confirmed stable gravity.
6. Aging: extended bottle maturation recommended for the high-strength target.
